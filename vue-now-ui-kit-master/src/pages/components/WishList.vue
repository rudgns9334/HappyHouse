    ...
    <div class="container">
      <div class="align-items-center">
        <div class="col-lg-6" style="margin: auto">
          <h2 class="font-weight-bold text-primary heading" style="text-align: center; margin-bottom: 80px; margin">WISH LIST</h2>
        </div>
      ...
      <div class="row">
        <div v-show="isEmpty" class="bgDiv">
          <div style="text-align: center;"><h1 style="color: #fff;"><strong>No WishList</strong></h1></div>
        </div>
