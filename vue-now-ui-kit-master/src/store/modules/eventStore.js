...
export default {
  ...
  mutations: {
    ...
    SET_EVENT_DETAIL(state, payload) {
      ...
      state.event.startDt = util.makeDateStr(
        payload.startDt.date.year,
        payload.startDt.date.month,
        payload.startDt.date.day,
        ".",
      );
      state.event.endDt = util.makeDateStr(
        payload.endDt.date.year,
        payload.endDt.date.month,
        payload.endDt.date.day,
        ".",
      );
